        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Link to="/" className="flex items-end cursor-pointer">
              ...
              <span className="mb-4 text-primary font-bold">CARWASH</span>
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center">
            ...
            <div className="relative mr-3" ref={mobileThemeMenuRef}>
              <button
                ...
                className="p-2 text-base-content hover:text-primary cursor-pointer flex items-center"
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -top-1 -right-1 bg-primary text-primary-content text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">
                  {totalItems}
                </span>
              )}
            </button>
          ...
          <nav className="hidden md:flex space-x-8">
            <NavLink to="/" className={({ isActive }) =>
              isActive ? "text-primary font-medium" : "hover:text-primary transition-colors font-medium"
            }>
              Startseite
            </NavLink>
            ...
            <NavLink to="/admin" className={({ isActive }) =>
              isActive || isAuthenticated ? "text-primary font-medium" : "hover:text-primary transition-colors font-medium"
            }>
              Admin
            </NavLink>
          </nav>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative" ref={desktopThemeMenuRef}>
              <button
                onClick={toggleThemeMenu}
                className="p-2 text-base-content hover:text-primary flex items-center cursor-pointer"
                aria-label="Design ändern"
              >
        ...
        {isMenuOpen && (
          <nav className="md:hidden py-4 border-t mt-3">
            <div className="flex flex-col space-y-3">
              <Link to="/" className="py-2 hover:text-primary transition-colors">Startseite</Link>
              <Link to="/products" className="py-2 hover:text-primary transition-colors">Unsere Produkte</Link>
              <Link to="/about" className="py-2 hover:text-primary transition-colors">Über uns</Link>
              <Link to="/admin" className={`py-2 hover:text-primary transition-colors ${isAuthenticated ? "text-primary" : ""}`}>Admin</Link>
            </div>
          </nav>
        )}
      </div>
